    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-date_done'],
                'indexes': [models.Index(fields=['date_created'], name='django_cele_date_cr_bd6c1d_idx'), models.Index(fields=['date_done'], name='django_cele_date_do_caae0e_idx')],
            },
        ),
        migrations.CreateModel(
            name='TaskResult',
            fields=[
                ...
                ('periodic_task_name', models.CharField(help_text='Name of the Periodic Task which was run', max_length=255, null=True, verbose_name='Periodic Task Name')),
                ...
                ('status', models.CharField(choices=[('FAILURE', 'FAILURE'), ('PENDING', 'PENDING'), ('RECEIVED', 'RECEIVED'), ('RETRY', 'RETRY'), ('REVOKED', 'REVOKED'), ('STARTED', 'STARTED'), ('SUCCESS', 'SUCCESS')], default='PENDING', help_text='Current state of the task being run', max_length=50, verbose_name='Task State')),
